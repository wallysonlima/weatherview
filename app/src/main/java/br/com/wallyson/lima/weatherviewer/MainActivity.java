...
public class MainActivity extends AppCompatActivity {
    ...
    private ListView weatherListView; // displays weather

    // configure Toolbar, ListView and FAB
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // auto-generated code to inflate layout and configure Toolbar
        ...
        // configure FAB to hide keyboard and initiate web service
    ...
    private class GetWeatherTask extends AsyncTask<URL, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject weather) {
            convertJSONtoArrayList(weather); // repopulate weather
    ...
    private void convertJSONtoArrayList(JSONObject forecast) {
        ...
        try {
            ...
            for ( int i = 0; i < list.length(); ++i ) {
                ...
                // get day's "weather" JSONObject for the description
                JSONObject weather =
